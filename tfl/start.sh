...
docker-machine create --driver digitalocean --digitalocean-region=lon1  --digitalocean-size=512mb --digitalocean-access-token=$DIGOCTOK  --digitalocean-image ubuntu-14-04-x64 tfl
